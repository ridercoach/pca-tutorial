...
Each column in the above table holds the components of a unit vector^[Technically, 
an "eigenvector of the covariance matrix", as you can learn from many online 
sources.  However, `prcomp()` uses singular value decomposition (SVD) to get the 
same result, for greater numerical accuracy.] in the 
